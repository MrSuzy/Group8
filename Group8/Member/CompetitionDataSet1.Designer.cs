...
namespace Group8.Member {
    ...
    public partial class CompetitionDataSet : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MembersRow AddMembersRow(int Id, string Name, string Password, string Email, int Contact) {
...
namespace Group8.Member.CompetitionDataSetTableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Members] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Members] ([Id], [Name], [Password], [Email], [Contact]) VALUES" +
                " (@Id, @Name, @Password, @Email, @Contact);\r\nSELECT Id, Name, Password, Email, C" +
                "ontact FROM Members WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [Id] = @Id, [Name] = @Name, [Password] = @Password, [Email] = @Email, [Contact] = @Contact WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)));
SELECT Id, Name, Password, Email, Contact FROM Members WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Group8.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Password, Email, Contact FROM dbo.Members";
        ...
        public virtual int Fill(CompetitionDataSet.MembersDataTable dataTable) {
        ...
        public virtual CompetitionDataSet.MembersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CompetitionDataSet.MembersDataTable dataTable = new CompetitionDataSet.MembersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CompetitionDataSet.MembersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Password, string Original_Email, global::System.Nullable<int> Original_Contact) {
        ...
        public virtual int Insert(int Id, string Name, string Password, string Email, global::System.Nullable<int> Contact) {
        ...
        public virtual int Update(int Id, string Name, string Password, string Email, global::System.Nullable<int> Contact, int Original_Id, string Original_Name, string Original_Password, string Original_Email, global::System.Nullable<int> Original_Contact) {
            ...
            if ((Original_Contact.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_Contact.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, string Email, global::System.Nullable<int> Contact, int Original_Id, string Original_Name, string Original_Password, string Original_Email, global::System.Nullable<int> Original_Contact) {
            return this.Update(Original_Id, Name, Password, Email, Contact, Original_Id, Original_Name, Original_Password, Original_Email, Original_Contact);
        }
    }
